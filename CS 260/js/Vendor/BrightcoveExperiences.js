...
if (brightcove.experiences == undefined) {
    brightcove.servicesURL = 'https://secure.brightcove.com/services';
    brightcove.cdnURL = 'https://sadmin.brightcove.com';
    ...
    brightcove.createExperiences = function(pEvent, pElementID) {
        ...
        for (var i = 0; i < numExperiences; i++) {
            ...
            if (document.location.protocol == "https:") {
                var event = 'https://goku.brightcove.com/1pix.gif?';
    ...
    brightcove.getFlashEmbedString = function(experience, secureConnections) {
        ...
        return '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + ' codebase="' + protocol + '://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=' + brightcove.majorVersion + ',' + brightcove.majorRevision + ',' + brightcove.minorRevision + ',0"' + ' id="' + experience.id + '"' + ' width="' + experience.params.width + '"' + ' height="' + experience.params.height + '"' + ' type="application/x-shockwave-flash"' + ' class="BrightcoveExperience">' + options + '</object>';
    };
